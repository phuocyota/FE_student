  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <InputField label="Mã học sinh" name="studentId" value={tempData.studentId} isEditing={isEditing} disabledEdit />

        <InputField label="Ngày sinh" name="dob" value={tempData.dob} isEditing={isEditing} type="date" disabledEdit />

        <InputField label="Giới tính" name="gender" value={tempData.gender} isEditing={isEditing} disabledEdit />
  ...
  <div>
    ...
    {isEditing ? (
      <input
        ...
        className={`w-full border-b border-gray-100 pb-1 focus:outline-none 
        ${disabledEdit
